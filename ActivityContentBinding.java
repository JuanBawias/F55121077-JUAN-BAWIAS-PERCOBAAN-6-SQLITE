...
public final class ActivityContentBinding implements ViewBinding {
  ...
  private ActivityContentBinding(@NonNull ConstraintLayout rootView,
      @NonNull FrameLayout containerLayout, @NonNull BottomNavigationView navigation) {
  ...
  public static ActivityContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout containerLayout = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityContentBinding((ConstraintLayout) rootView, containerLayout, navigation);
    }
